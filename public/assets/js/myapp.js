...
function http(id_token) {
  $.post("https://pulse-alert-api.herokuapp.com/user/", {token: id_token},   (user) => {
    ...
    $.post("https://pulse-alert-api.herokuapp.com/update/",{token: id_token, updates:
      [{
        givenName: "ben",
        familyName: "spille",
...
function sendPulse(userLat, userLong) {
    ...
    $.post("https://pulse-alert-api.herokuapp.com/pulse/", {token: id_token, geoLocation: { latitude: userLat, longitude: userLong}});
    // console.log(userLat);
